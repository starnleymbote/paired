...
public class TinyDB {
     ...
     * @return the full path of the image. If it failed to create directory, returnIcon empty string
     */
    ...
    /**
     * Get int value from SharedPreferences at 'key'. If key not found, returnIcon 'defaultValue'
    ...
    /**
     * Get long value from SharedPreferences at 'key'. If key not found, returnIcon 'defaultValue'
     * @param key SharedPreferences key
    ...
    /**
     * Get float value from SharedPreferences at 'key'. If key not found, returnIcon 'defaultValue'
     * @param key SharedPreferences key
    ...
    /**
     * Get double value from SharedPreferences at 'key'. If exception thrown, returnIcon 'defaultValue'
     * @param key SharedPreferences key
    ...
    /**
     * Get String value from SharedPreferences at 'key'. If key not found, returnIcon ""
     * @param key SharedPreferences key
    ...
    /**
     * Get boolean value from SharedPreferences at 'key'. If key not found, returnIcon 'defaultValue'
     * @param key SharedPreferences key
...
//    }
    ...
    /**
     * Retrieve all values from SharedPreferences. Do not modify collection returnIcon by method
